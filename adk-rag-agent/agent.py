...
rag_retrieval_tool = VertexAiRagRetrieval(
    name="retrieve_ai_act_corpus",
    description=(
        "Use this tool to retrieve the most relevant passages from the AI Act corpus. "
...
# ======================================================================================
# 2) RAGAnalyzerAgent
#    - Job: read normalized passages JSON, analyze, cluster ideas, and produce
#      a concise structured analysis (not the final answer).
# ======================================================================================
analyzer_agent = LlmAgent(
    name="RAGAnalyzerAgent",
    model=GEMINI_MODEL,
    description="Analyzes retrieved passages and produces a structured synthesis.",
    output_key="analysis_memo",  # becomes available as {analysis_memo}
    instruction=return_instructions_rag_analyser()
)

# ======================================================================================
# 3) RAGFinalAnswerAgent
#    - Job: write the final answer using the analysis memo + passages, with inline
...
# ======================================================================================
# 4) Compose into a SequentialAgent
# ======================================================================================
